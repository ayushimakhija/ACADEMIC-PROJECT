...
public class AddingData {
    public static void main(String[] args) {
        ...
        List<Course> courses = studentDao.getPassedCourses(student2);
        ...
        for (String specializationCode : specializationCredit.keySet()) {
            if (courseGrade.get(specializationCode) >= specializationCredit.get(specializationCode)) {
                System.out.println(student2.getEmail() + " has specialization in " + specializationCode);
                studentDao.updateStudentSpecialization(student2, specializationDao.getSpecializationByCode(specializationCode));
                break;
            }
        }
